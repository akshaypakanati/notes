...
internal class BaseRoundedCardCell: UICollectionViewCell {
    ...
    internal static let cellHeight: CGFloat = 100
    
    private static let kInnerMargin: CGFloat = 3.0
    ...
    private func configureShadow() {
        ...
        self.applyShadow(width: 2, height: 2)
...
//        }
    ...
    private func applyShadow(width: CGFloat, height: CGFloat) {
        if let shadowView = shadowView {
            let shadowPath = UIBezierPath(roundedRect: shadowView.bounds, cornerRadius: 4.0)
